...
} from "@pdf-comparer/embed";
import { getT, type Locale as WebLocale } from "../../i18n";
import "./pdf-comparer.css";

// The pdf-comparer animation currently ships English only. We pin the player
// to "en" regardless of the website locale, while keeping the embed surface
// ready for additional locales to drop in later.
...
export default function InteractiveViewer({ locale }: Props) {
  ...
  const tInteractive = tWeb.pdfComparer.interactive;
  ...
  // fully opaque. Scenes fade out in their last frames; stopping near
  // `range.end` would land on a near-invisible frame.
